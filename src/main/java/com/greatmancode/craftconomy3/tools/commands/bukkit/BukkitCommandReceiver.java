...
public class BukkitCommandReceiver implements CommandReceiver, CommandExecutor {
    ...
    public boolean onCommand(CommandSender commandSender, Command command, String s, String[] args) {
        ...
        if (subCommand != null) {
            ...
            com.greatmancode.craftconomy3.tools.commands.CommandSender sender = null;
            if (commandSender instanceof ConsoleCommandSender) {
                sender = new com.greatmancode.craftconomy3.tools.commands.ConsoleCommandSender<>(commandSender.getName(), commandSender);
