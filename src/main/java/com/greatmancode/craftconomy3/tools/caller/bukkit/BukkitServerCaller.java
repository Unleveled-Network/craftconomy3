...
public class BukkitServerCaller extends ServerCaller {
    ...
    public void throwEvent(Event event) {
        if (event instanceof EconomyChangeEvent) {
            ((BukkitLoader) loader).getServer().getPluginManager().callEvent(new com.greatmancode.craftconomy3.tools.events.bukkit.events.EconomyChangeEvent(((EconomyChangeEvent) event).getAccount(), ((EconomyChangeEvent) event).getAmount()));
        }
    }
    ...
    @Override
    public void setVaultEconomyHook(VaultEconomy instance, com.greatmancode.craftconomy3.tools.utils.ServicePriority priority) {
